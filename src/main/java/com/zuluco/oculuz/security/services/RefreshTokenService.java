...
import com.zuluco.oculuz.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
  ...
  public void deleteExpiredTokens() {
    refreshTokenRepository.deleteAllByExpiryDateLessThan(Instant.now());
  }

    public void deleteByToken(String requestRefreshToken) {
